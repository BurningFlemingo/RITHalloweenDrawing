...
def main() -> None:
    ...
    cube: Model = Model(load_obj("assets\\pumpkin.obj"),
                        load_bmp("assets\\pumpkin.bmp"))
    house: Model = Model(load_obj("assets\\test.obj"),
                         load_bmp("assets\\test.bmp"))
    ...
    draw(framebuffer, viewport, uniforms,
         house.vertices, 0, len(house.vertices[0]))
