...
class SkyboxVertexShader:
    ...
    def __call__(self, in_attributes: Attributes) -> Vertex:
        ...
        out_position = projection_matrix * view_matrix * Vec4(*in_attributes.pos, 1.0)
        out_position = Vec4(out_position.x, out_position.y, out_position.w, out_position.w)
...
class SkyboxFragmentShader:
    ...
    def __call__(self, attributes: SkyboxVertexShader.OutAttributes) -> list[Vec4]:
        return [self.skybox.sample(attributes.dir)]
